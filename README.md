...
The Virtual Desk Organiser connects to Wi-Fi and fetches live information from APIs. Data is processed by the ESP32-S3 and displayed on the e-paper screen. A web dashboard allows users to manage tasks, alarms, and settings remotely.

🔄 Working Principle
ESP32 connects to Wi-Fi.
APIs fetch weather, quotes, and calendar data.
User tasks and alarms are managed through the dashboard.
E-paper display updates important information.
PIR sensor detects activity and controls power-saving modes.
Solar panel can provide sustainable power support.
🌍 Applications
